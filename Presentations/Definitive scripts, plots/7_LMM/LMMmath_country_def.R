# LINEAR MIXED MODELS (math , country)
...
fixef(lmm2)
# Since sig02 is not significant (and it is the one related to correlation), we try the model below
...
# Comparing models
anova(lmm1, lmm2)
# The p-value for the test is essentially zero 
# => We prefer the model lmm2 (which has also lower AIC)
