...
lmm2 = lmer(math ~ gender + fear_failure + bullied + ESCS_status + 
              + (1|school_id), 
            data = studentsData)
summary(lmm2)
...
# Fixed Effects and 95% CIs
#-------------------------------
confint(lmm2, oldNames=TRUE) #hisced e learn_time_math non significant al 95% probabilmente al 99% si
#forse meglio rifare modello senza
fixef(lmm2)
...
sigma2_eps
sigma2_b <- as.numeric(get_variance_random(lmm2))
sigma2_b
