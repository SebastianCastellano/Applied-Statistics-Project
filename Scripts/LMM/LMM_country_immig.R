...
studentsData = studentsDataImmigrant
...
lm1 <- lm(math ~ gender + hisced + grade_rep+ bullied + 
            + home_poss + cult_poss + edu_resources + family_wealth + ESCS_status + 
            + stu_behav + teach_behav , data = studentsData)
summary(lm1)
...
lmm1 = lmer(math ~ gender + hisced + grade_rep+ bullied + 
              + home_poss + cult_poss + edu_resources + family_wealth + ESCS_status + 
              + stu_behav + teach_behav + (1|country), 
            data = studentsData)
summary(lmm1)
