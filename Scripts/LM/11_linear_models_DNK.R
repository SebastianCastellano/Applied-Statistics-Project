...
# tutte le variabili (no country) DA RIFARE con nuove variabili 
...
gm3 <- lm(math ~ gender + immigration + language + hisced + grade_rep + fear_failure + belonging + bullied + 
            + ESCS_status + teacher_support + emo_sup + learn_time_math + short_edu_mat + 
            + stu_behav + teach_behav + immigration:gender + immigration:language + immigration:hisced + 
            + immigration:grade_rep + immigration:fear_failure + immigration:bullied + 
            + immigration:ESCS_status + immigration:teacher_support + immigration:emo_sup + immigration:learn_time_math + 
            + immigration:short_edu_mat + immigration:short_edu_staff + immigration:teach_behav)
...
gm3 <- lm(math ~ gender + immigration + language + hisced + grade_rep + fear_failure + belonging + bullied + 
            ...
            + stu_behav + teach_behav + immigration:gender + immigration:language + immigration:hisced + 
            + immigration:grade_rep + immigration:fear_failure + immigration:bullied + 
            + immigration:ESCS_status + immigration:emo_sup + immigration:learn_time_math + 
            + immigration:short_edu_mat + immigration:short_edu_staff + immigration:teach_behav)
summary(gm3)
...
# Tolgo short_edu_mat
gm3 <- lm(math ~ gender + immigration + language + hisced + grade_rep + fear_failure + belonging + bullied + 
            + ESCS_status + teacher_support + emo_sup + learn_time_math +  
            + stu_behav + teach_behav + immigration:language + immigration:hisced + 
            + immigration:grade_rep + immigration:fear_failure + immigration:bullied + 
            + immigration:ESCS_status + immigration:emo_sup + immigration:learn_time_math + 
            + immigration:short_edu_mat + immigration:short_edu_staff + immigration:teach_behav)
...
# Tolgo emo_sup 
gm3 <- lm(math ~ gender + immigration + language + hisced + grade_rep + fear_failure + belonging + bullied + 
            + ESCS_status + teacher_support + learn_time_math +  
            + stu_behav + teach_behav + immigration:language + immigration:hisced + 
            + immigration:grade_rep + immigration:bullied + 
            + immigration:ESCS_status + immigration:emo_sup + immigration:learn_time_math + 
            + immigration:short_edu_staff + immigration:teach_behav)
...
gm3 <- lm(math ~ gender + immigration + language + hisced + grade_rep + fear_failure + belonging + bullied + 
            ...
            + stu_behav + teach_behav + immigration:language + immigration:hisced + 
            + immigration:grade_rep + immigration:bullied + 
            + immigration:ESCS_status + immigration:emo_sup + immigration:teach_behav)
summary(gm3)

# Tolgo immigration:hisced 
gm3 <- lm(math ~ gender + immigration + language + hisced + grade_rep + fear_failure + belonging + bullied + 
            + ESCS_status + teacher_support + learn_time_math + stu_behav + teach_behav + 
            + immigration:language + immigration:grade_rep + immigration:bullied + 
            + immigration:ESCS_status + immigration:emo_sup + immigration:teach_behav)
summary(gm3)
...
gm3 <- lm(math ~ gender + immigration + language + hisced + grade_rep + fear_failure + belonging + bullied + 
            + ESCS_status + teacher_support + learn_time_math + stu_behav + teach_behav + 
            + immigration:language + immigration:grade_rep + immigration:bullied + 
            + immigration:ESCS_status + immigration:teach_behav)
summary(gm3)
...
# Tolgo language 
gm3 <- lm(math ~ gender + immigration + hisced + grade_rep + fear_failure + belonging + 
            + ESCS_status + teacher_support + learn_time_math + stu_behav + teach_behav + 
            + immigration:grade_rep + immigration:bullied + immigration:ESCS_status)
summary(gm3)
